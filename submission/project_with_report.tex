...
0.11\strut
\end{minipage} & \begin{minipage}[t]{0.82\columnwidth}\raggedright
frozenset(\{`has\_three\_g', `front\_cam\_resolution\_category\_(0.981,
5.5{]}', `has\_four\_g', `px\_height\_category\_(-1.9609999999999999,
490.0{]}'\})\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.03\columnwidth}\raggedleft
716\strut
...
0.105\strut
\end{minipage} & \begin{minipage}[t]{0.82\columnwidth}\raggedright
frozenset(\{`has\_three\_g', `screen\_width\_category\_(-0.019, 4.5{]}',
`has\_four\_g', `px\_height\_category\_(-1.9609999999999999,
490.0{]}'\})\strut
\end{minipage}\tabularnewline
\bottomrule
\end{longtable}
...
\end{tcolorbox}
    ...
    \begin{figure}
\centering
\includegraphics{project_with_report_files/project_with_report_141_1.png}
\caption{PCA\_cumulative}
\end{figure}
...
\PY{c+c1}{\PYZsh{}attributes\PYZus{}df.sort\PYZus{}values(\PYZdq{}score\PYZdq{}).plot(x=\PYZdq{}attribute\PYZus{}name\PYZdq{},y=\PYZdq{}score\PYZdq{},kind=\PYZdq{}barh\PYZdq{}, logx=True)}
\PY{c+c1}{\PYZsh{}print(f\PYZdq{}Number of Attributes: \PYZob{}len(attributes\PYZus{}df)\PYZcb{}\PYZdq{})}
\end{Verbatim}
\end{tcolorbox}
...
Number of Attributes: 17
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{project_with_report_files/project_with_report_169_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Number of Attributes: 10
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{project_with_report_files/project_with_report_176_1.png}
    \end{center}
    { \hspace*{\fill} \\}
